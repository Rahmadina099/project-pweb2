    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <a href="form_profil_dokter.php"><i class="fa fa-circle-o"></i> Dokter</a></li>
          
          <li class="formpasien.php"><a href="formpasien.php"><i class="fa fa-circle-o"></i> Pasien</a>
          <li class="formRM"><a href="formrecammedis.php"><i class="fa fa-circle-o"></i> Rekam medis</a>
          <li class="halaman">
          <a href ="halaman utama.php">HOME</a></li>
